...
int main(void)
{
	...
	BOOKS_vidInsertion(019281785, "Charles Dickens", 5);
	BOOKS_vidInsertion(025486198, "Paulo Coelho", 5);
	BOOKS_vidInsertion(033010690, "Emily Bronte", 5);
	BOOKS_vidInsertion(058207719, "Jane Eyre", 5);
	BOOKS_vidInsertion(44758, "Eileen Power", 5);
